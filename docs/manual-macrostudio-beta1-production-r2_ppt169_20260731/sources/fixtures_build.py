...
SCRATCH = HERE.parent
SRC_JSON = SCRATCH / "win32sleep-modules.json"

BOOK_NAME = "sample_win32_sleep.xlsm"
BOOK_DIR = r"C:\Tools\MacroStudio\sample-book"
RUN_STAMP = "20260731_103000"
...
fixture = {
    ...
    "runFolder": (BOOK_DIR + "\\MacroStudio\\"
                  + BOOK_NAME.rsplit(".", 1)[0] + "_" + RUN_STAMP),
