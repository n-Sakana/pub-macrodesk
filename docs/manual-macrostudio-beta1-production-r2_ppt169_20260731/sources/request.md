...
'@MACROSTUDIO c6f5b9a0-653c-4534-8394-127179257dc3 SUMMARY BEGIN
（何をどう直したか。モジュール名を挙げて 3〜6 行程度。
　マクロを書かない人にも分かる言葉で）
'@MACROSTUDIO c6f5b9a0-653c-4534-8394-127179257dc3 SUMMARY END

続けて、モジュールごとに次の行ではさみます。

'@MACROSTUDIO c6f5b9a0-653c-4534-8394-127179257dc3 BEGIN <種類> <モジュール名>
（そのモジュールの全文）
'@MACROSTUDIO c6f5b9a0-653c-4534-8394-127179257dc3 END <種類> <モジュール名>

すべてのモジュールを書き終えたら、最後に次の 1 行を置いてください。

'@MACROSTUDIO c6f5b9a0-653c-4534-8394-127179257dc3 COMPLETE <モジュールの数>
...
- c6f5b9a0-653c-4534-8394-127179257dc3 は今回の依頼の番号です。書き換えたり省略したりしないでください。
