...
指摘が 0 件なら FINDING を書かず、`DIAG NOFINDING SCOPE_CLEAR` または
`DIAG NOFINDING INSUFFICIENT` を 1 行だけ書き、`DIAG COMPLETE 0` とします。
指摘がある場合は NOFINDING を書かず、COMPLETE の数を FINDING 件数と一致させます。
